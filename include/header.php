         ...
         <div class="collapse navbar-collapse text-center" id="navigation">
            <ul class="navbar-nav mx-auto">
               ...
               <li class="nav-item">
				...
				<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">CONTACT US <b class="caret"></b></a>
               ...
               <li class="dropdown nav-item">
				<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">ANNOUNCEMENT <b class="caret"></b></a>
				<ul class="dropdown-menu dropdown-menu-large row">
					<li class="col-sm-12">
						<ul>
